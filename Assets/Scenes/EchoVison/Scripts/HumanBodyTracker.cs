...
namespace UnityEngine.XR.ARFoundation.Samples
{
    public class HumanBodyTracker : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            Debug.Log("OnHumanBodiesChanged Binded");
        ...
        {
            Debug.Log(string.Format("OnHumanBodiesChanged | Added:{0}, Updated:{1}, Removed:{2}", eventArgs.added.Count, eventArgs.updated.Count, eventArgs.removed.Count));
